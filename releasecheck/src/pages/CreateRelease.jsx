    ...
    <div className="bg-gray-100 h-screen w-screen">
        ...
        <div className="relative overflow-hidden bg-white shadow-sm rounded-xl border border-gray-400 mx-6">
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                  <div className="flex items-center space-x-1.5">
                    ...
                    <a href="#" className="inline-flex items-center text-gray-500 underline text-md font-medium text-body hover:text-fg-brand">Projects</a>
                  </div>
                </li>
              </ol>
            </nav>

            <button onClick={handleSubmit} className="flex gap-2 bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded cursor-pointer">
          ...
          <div className="overflow-x-auto mx-4 mt-2">
            <div className="mb-5">
              ...
              <input value={name}
                onChange={(e) => setName(e.target.value)} type="text" id="release" className=" border border-default-medium border-gray-500 text-heading text-sm block w-100 px-3 py-2.5 rounded" placeholder="Versin 0.0.1" required />
            </div>
           <div className="mb-5">
      <label htmlFor="release" className="block mb-2.5 text-sm font-medium text-gray-900">
        ...
        <input 
          ...
          className="block w-100 ps-10 pe-3 py-2.5 border border-gray-500 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500" 
        />
    </div>
            <div className="mb-5">
              <label for="message" className="block mb-2.5 text-sm font-medium text-heading">Addional info</label>
              <textarea id="message" rows="4" value={info}
                onChange={(e) => setInfo(e.target.value)} className="border border-default-medium border-gray-500 text-heading text-sm rounded block w-120 p-3.5" placeholder="Please Add any other important notes for the release"></textarea>
            </div>
          </div>
        </div>
      </div>
